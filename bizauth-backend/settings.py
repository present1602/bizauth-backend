...
SECRET_KEY = 'django-insecure-woy0sj3uw+^g4clu5aaf*^_0x-*xx-emk!@ph_6xym411eh_+0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['3.37.133.242']
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": True,  # True -> token/refresh  -> accesstoken과 refresh 같이 보냄
...
WSGI_APPLICATION = 'bizauth-backend.wsgi.application'
